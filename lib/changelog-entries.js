...
export const ENTRIES = [
  {
    date: '2026-05-28',
    tag: 'ai',
    title: 'AI KB: drawdown reading framework — pair maxDrawdownPct (worst peak-to-trough shock) with currentDrawdownPct (distance from ATH), gate the flag-worthy threshold on > 30% depth AND > 30 days duration together (not depth alone), use currentlyUnderwater as the durability signal that separates a recovered shock from an ongoing one, and route drawdown responses to concentration/sizing axes — never to validator switching, which only moves the yield component the drawdown did not come from',
    body:
