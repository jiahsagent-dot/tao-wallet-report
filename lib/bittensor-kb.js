...
export const SUBNET_DOSSIER = {
  ...
  5: { name: 'Open Kaito', purpose: 'Decentralised web search index. Crawler/indexer miners.', priceRange6mo: { min: 0.013817, p10: 0.014396, median: 0.017174, p90: 0.020378, max: 0.023043, samples: 180, asOf: '2026-06-27' } },
  ...
  8: { name: 'Proprietary Trading Network (PTN)', purpose: 'Crypto trading-signal subnet. Miners run trading strategies, scored on PnL.', priceRange6mo: { min: 0.030339, p10: 0.030806, median: 0.035675, p90: 0.043503, max: 0.044149, samples: 180, asOf: '2026-06-27' } },
  9: { name: 'Pretraining', purpose: 'Foundation model pretraining. Heavy-compute, validator-driven scoring.', priceRange6mo: { min: 0.022156, p10: 0.02275, median: 0.025988, p90: 0.031916, max: 0.040229, samples: 180, asOf: '2026-06-27' } },
  ...
  19: { name: 'Vision', purpose: 'Multimodal compute (vision + LLM). Active dev cadence.', priceRange6mo: { min: 0.010801, p10: 0.011417, median: 0.013902, p90: 0.016272, max: 0.017188, samples: 180, asOf: '2026-06-27' } },
  ...
  44: { name: 'Score', purpose: 'Scoring / ranking subnet. Active mid-2026 with material emission share (top-portfolio holdings observed); canonical spec not yet in KB — treat purpose-specifics as unconfirmed before citing.', priceRange6mo: { min: 0.016832, p10: 0.023276, median: 0.033567, p90: 0.042281, max: 0.046262, samples: 180, asOf: '2026-06-27' } },
  ...
  88: { name: 'Investing', purpose: 'Investment / portfolio-signal subnet — miners generate investment signals or portfolio analyses. Active mid-2026; treat purpose-specifics as unconfirmed before citing.', priceRange6mo: { min: 0.003477, p10: 0.003606, median: 0.004007, p90: 0.004873, max: 0.006886, samples: 180, asOf: '2026-06-27' } },
  120: { name: 'Affine', purpose: 'Model-tournament subnet — miners submit fine-tuned models graded by validators on Pareto-frontier performance across RL environments (program synthesis, code generation). Sybil/decoy/copy/overfit-proof scoring; winning models hosted for inference via Chutes (SN64). Top-5 subnet by TAO market cap as of 2026-07-01.' },
  121: { name: 'sundae_bar', purpose: 'Newer-cohort subnet (active mid-2026); canonical purpose not yet in KB. Flag as unconfirmed before citing any specifics; lean on the live alpha-price / emission share for any quantitative claim.', priceRange6mo: { min: 0.005409, p10: 0.005714, median: 0.007191, p90: 0.009342, max: 0.011342, samples: 180, asOf: '2026-06-27' } },
  128: { name: 'ByteLeap', purpose: 'Newer-cohort subnet (active mid-2026, materially present in top portfolios); canonical purpose not yet in KB. Flag as unconfirmed before citing specifics; lean on live emission share + price movement for any quantitative claim.', priceRange6mo: { min: 0.002715, p10: 0.003305, median: 0.003718, p90: 0.00402, max: 0.00441, samples: 180, asOf: '2026-06-27' } },
};
